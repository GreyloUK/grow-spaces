...
const models = [
  {
    id: 1,
    src: 'https://www.google.com/s2/favicons?domain=ads.google.com&sz=32',
    name: 'Google Ads'
  },
  {
    id: 2,
    src: 'https://www.google.com/s2/favicons?domain=hubspot.com&sz=32',
    name: 'HubSpot CRM'
  },
  {
    id: 3,
    src: 'https://www.google.com/s2/favicons?domain=cobot.me&sz=32',
    name: 'Cobot'
  }
]
...
const connectingItems = [
  {
    id: 1,
    text: 'Auditing website performance',
    image: 'https://www.google.com/s2/favicons?domain=search.google.com&sz=32'
  },
  {
    id: 2,
    text: 'Analysing ad campaign data',
    image: 'https://www.google.com/s2/favicons?domain=ads.google.com&sz=32'
  },
  {
    id: 3,
    text: 'Syncing CRM and member records',
    image: 'https://www.google.com/s2/favicons?domain=hubspot.com&sz=32'
  },
  {
    id: 4,
    text: 'Mapping member booking journey',
    image: 'https://www.google.com/s2/favicons?domain=cobot.me&sz=32'
  }
]
      ...
      {(showConnecting || showExecutionSummary) && (
        ...
        >
          ...
          >
            ...
            >
              {showExecutionSummary ? 'Growth Plan Ready' : 'Connecting tools'}
            </motion.span>
            <MoreVerticalIcon
              className={cn(
                'size-4',
      ...
      <div className='bg-card rounded-b-xl border !border-t-0 p-4 pt-0'>
        <div className='flex items-center justify-between gap-4'>
          <div className='flex items-center gap-3'>
            <DropdownMenu>
              <DropdownMenuTrigger render={<Button variant='ghost' size='sm' />}><img src={selectedModel.src} alt={selectedModel.name} className='size-4.5' /><span>{selectedModel.name}</span><ChevronDownIcon /></DropdownMenuTrigger>
