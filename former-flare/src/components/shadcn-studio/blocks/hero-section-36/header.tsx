    ...
    >
      <div className='mx-auto flex h-full max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex gap-3'>
          ...
          />
          {/* Actions */}
          <Button variant='outline' className='rounded-full px-4! max-sm:hidden' render={<a href='#' />} nativeButton={false}>Let’s talk <MessageSquareMoreIcon /></Button>

          <Button variant='outline' size='icon' className='rounded-full px-4! sm:hidden' render={<a href='#' />} nativeButton={false}><span className='sr-only'>Let’s talk</span><MessageSquareMoreIcon /></Button>
