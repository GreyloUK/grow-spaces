...
const HeroNavigation01SmallScreen = ({
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger render={<Button variant='outline' size='icon' className={cn('inline-flex lg:hidden', triggerClassName)} />}><MenuIcon /><span className='sr-only'>Menu</span></SheetTrigger>
